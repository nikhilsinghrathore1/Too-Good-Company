    ...
    <div className='w-full h-screen gilroy flex items-center justify-center bg-[#151519]'>
              <div className='w-[90%] h-[95%] flex rounded-[40px] overflow-hidden bg-white'>
               ...
               <div className='form w-full mt-[100px] px-10'>
                              <h1 className='text-lg mb-5 gilb'>Login to your Account</h1>
                              <form  onSubmit={handleSubmit(onSubmit)}>
                                             <div className='flex-col w-full flex gap-1 mb-2'>
                                             <label className='text-[11px] gilb'>Username*</label>
                                             <input {...register("username")} className='w-full text-[13px] outline-none bg-[#F8F8F8] p-2 border-zinc-600/50 rounded-sm border-[1px]' name='username' type="text" placeholder='username' />
                                             </div>
                                             <div className='flex-col w-full flex gap-1 mb-2'>
                                             <label className='text-[11px] gilb'>E-mail*</label>
                                             <input {...register("email")} className='w-full outline-none text-[13px] bg-[#F8F8F8] p-2 border-zinc-600/50 rounded-sm border-[1px]' name="email" type="email" placeholder='E-mail' />
                                             </div>
                                             ...
                                             <input {...register("password")} className='w-full text-[13px] outline-none bg-[#F8F8F8] p-2 border-zinc-600/50 rounded-sm border-[1px]' name="password" type="password" placeholder='Password' />
                                             </div>
                                             ...
                                             <button type='submit' className='w-full p-1 bg-[#151519] mt-4 text-white'>Login and Proceed</button>
                              </form>
                              ...
                              <div className='w-full border-t-[1px] mt-5 border-black/30'>
                                             <div className='w-full flex gap-1 mt-4 justify-center'>
                                                            <div className='w-[44%] border-black/20 border-[1px] pl-4 p-[1px] rounded-sm flex gap-1 items-center '>
                                                                           ...
                                                                           <p className='text-xs gilb opacity-75'>Login with Google</p>
                                                            </div>
                                                            
                                                            <div className='w-[44%] border-black/20 border-[1px] p-[1px] pl-4 rounded-sm flex gap-1 items-center '>
                                                                           <FaGithub className='text-xl'/>
                                                                           <p className='text-xs gilb opacity-75'>Login with Github</p>
                                                            </div>
                                                            
                                             </div>

                                             <div className='w-full flex justify-center mt-4'>
                                                            <button onClick={()=>navigate('/register')} className='text-xs text-[#484747] '>Don't have a Account?<span className='gilb text-black ml-1'>Sign-up now</span></button>
                                             </div>
                              </div>
               </div>
