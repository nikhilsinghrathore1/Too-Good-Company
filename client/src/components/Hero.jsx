  ...
  return (
    <div className='w-full h-[235vh]  pt-[22px] pr-[0px] overflow-hidden  pl-[19px] relative text-black'>
               <nav className='flex items-start justify-between pr-6'>
                              ...
                              <div>
               <svg  width="103" height="75" viewBox="0 0 106 83" fill="none" xmlns="http://www.w3.org/2000/svg"
               >
                    ...
                    <clipPath id="clip0_2228_162">
                        <rect width="106" height="82.3538" fill="white"></rect>
                              ...
                              <div className='flex items-center gap-[61.5px] pt-[2px]tracking-tight font9 opacity-95  uppercase text-[11px]'>
                                             ...
                                             <p>donate</p>
                                             <div>
                                             <p className='flex flex-col ml-2 gap-[4.5px] hover:gap-[2px] tran '> <span className='w-4 border-t-[1px] inline-block border-black '></span> <span  className='w-4 border-t-[1px] inline-block border-black'></span></p>
                                             </div>
               ...
               <div className='font10 mt-[103px] uppercase text-[14.4rem] leading-[195px] -tracking-[0.053em] '>
                ...
                <p>the course</p>
                    ...
                    {/* this is the main picture section */}
                <div className='w-full h-[104vh] mt-4 flex px-5'>
                    <div className='w-full h-full'>
                        <img className='w-full h-full object-cover' src="https://cdn.sanity.io/images/w8f1ak3c/production/8a379761371c4f616ee067f3ec605131129344ec-3120x1463.png/Soaps%20(1).png?rect=212,0,2696,1463&w=1920&h=1042&fit=min&auto=format" alt="not showing" />
                    </div>
                </div>
